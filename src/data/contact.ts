...
export const contactInfo = {
  description:
    "¿Querés trabajar conmigo o conversar sobre un proyecto? Escribime, estoy disponible para nuevas oportunidades.",
  ...
  methods: [
    ...
    },
    {
      ...
      href: "https://www.linkedin.com/in/alejo-diaz-432ab3387/",
      icon: "💼",
